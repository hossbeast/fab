...
fml_1_0()
{
  ...
  exec 2>&100
	...
	cat ./fab/man/fab.1  | sed -e 's/---BUILDVERS---/v0.5.1.0/'  | sed -e 's/---BUILDDATE---/2015-02-10/'  | gzip -9c > fab/man/fab.1.gz
...
fml_1_1()
{
  ...
  exec 2>&101
	...
	cat ./listwise/listwise/man/listwise.1  | sed -e 's/---BUILDVERS---/v0.5.1.0/'  | sed -e 's/---BUILDDATE---/2015-02-10/'  | gzip -9c > listwise/listwise/man/listwise.1.gz
