...
# fab --bslic-fab -k install64.dist.final.sh +n @install.dist.final -K destdir -K incdir -K bindir -K mandir -K libdir -K dlibdir -K lwopdir -K fablwopdir -K fabtmpdir -K fabipcdir -K fabinvokedir
...
NAMES[2]='@libxapi.install.final.xapi'
fml_2_0()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[3]='@libxlinux.install.final.xapi'
fml_3_0()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[4]='@libpstring.install.final.xapi'
fml_4_0()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[5]='@fabcore.fab.install.base.final'
fml_5_0()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[6]='@fabcore.fabd.install.base.final'
fml_5_1()
{
  exec 1>/dev/null
  exec 2>&101
...
NAMES[7]='@fabcore.fabw.install.base.final'
fml_5_2()
{
  exec 1>/dev/null
  exec 2>&102
...
NAMES[8]='@liblistwise.install.final.xapi'
fml_6_0()
{
  exec 1>/dev/null
  exec 2>&100
