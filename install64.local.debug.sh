...
NAMES[4]='@libxlinux.install.debug'
fml_3_0()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[5]='@libpstring.install.debug'
fml_4_0()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[6]='@listwise.install.debug'
fml_5_0()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[7]='@fabcore.fab.install.base.debug'
fml_6_0()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[8]='@fabcore.fabd.install.base.debug'
fml_6_1()
{
  exec 1>/dev/null
  exec 2>&101
...
NAMES[9]='@fabcore.fabw.install.base.debug'
fml_6_2()
{
  exec 1>/dev/null
  exec 2>&102
...
NAMES[10]='@liblistwise.install.debug'
fml_7_0()
{
  exec 1>/dev/null
  exec 2>&100
