...
#define COMMAND_TYPE_TABLE                                                                                                      \
  ...
  DEF(COMMAND_BOOTSTRAP          , "bootstrap"          , COMMAND_TYPE_OPT)                                                     \
  ...
  DEF(COMMAND_LIST               , "list"               , COMMAND_TYPE_OPT) /* get a list of the nodes in the selection */      \
  DEF(COMMAND_DESCRIBE           , "describe"           , COMMAND_TYPE_OPT) /* describe each of the nodes in the selection */   \
  DEF(COMMAND_INVALIDATE         , "invalidate"         , COMMAND_TYPE_OPT) /* invalidate each of the nodes in the selection */ \
