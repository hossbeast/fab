...
enum bam_global_state global_system_state = BAM_GLOBAL_STATE_BOOTSTRAP;
...
xapi global_system_reconcile(handler_context * restrict ctx, bool * restrict reconciled)
{
  ...
  *reconciled = true;
  ...
  /* reload config files */
  global_system_state = BAM_GLOBAL_STATE_CONFIG_SYSTEM_RECONCILE;
  ...
  /* HAXX - must be after first config parse */
  static int first;
  if(first == 0) {
    first = 1;
  ...
  global_system_state = BAM_GLOBAL_STATE_FILESYSTEM_RECONCILE;
  ...
  /* reload modules */
  global_system_state = BAM_GLOBAL_STATE_MODULE_SYSTEM_RECONCILE;
  ...
  global_system_state = BAM_GLOBAL_STATE_VAR_SYSTEM_RECONCILE;
  ...
  global_system_state = BAM_GLOBAL_STATE_RULE_SYSTEM_RECONCILE;
  ...
  global_system_state = BAM_GLOBAL_STATE_FORMULA_SYSTEM_RECONCILE;
  ...
  global_system_state = BAM_GLOBAL_STATE_OK;
  STATS_INC(g_stats.global_state_ok);
