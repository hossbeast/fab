...
#ifndef FF_NODE_PATTERN_INTERNAL_H
#define FF_NODE_PATTERN_INTERNAL_H
...
xapi ffn_pattern_say_normal(const ff_node_pattern * restrict n, struct narrator * restrict N)
  __attribute__((nonnull));
