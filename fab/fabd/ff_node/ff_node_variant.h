...
#ifndef _FF_NODE_VARIANT_H
#define _FF_NODE_VARIANT_H
...
typedef ff_node ff_node_variant;

xapi ffn_variant_match(struct pattern_match_context * restrict context, struct ffn_bydir_walk * restrict walk)
