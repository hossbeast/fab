 ...
 * used in pattern selectors for node lookup                   matches zero or more

variant pattern - list of strings (class/alternation permitted)
 * also used in module.bam to specify variants                 render only
 * the grammar is exactly the same as for lookup pattern
