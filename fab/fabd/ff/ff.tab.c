...
{
/* Line 387 of yacc.c  */
#line 44 "fabd/ff/ff.y"

	struct ff_node*			node;


/* Line 387 of yacc.c  */
#line 150 "fabd/ff/ff.tab.c"
} YYSTYPE;
...
int ff_yyparse (void *YYPARSE_PARAM);
#else
int ff_yyparse ();
#endif
#else /* ! YYPARSE_PARAM */
  ...
  switch (yytype)
    {
      case 28: /* statements */
/* Line 1393 of yacc.c  */
#line 104 "fabd/ff/ff.y"
        { ffn_free(((*yyvaluep).node)); };
/* Line 1393 of yacc.c  */
#line 1300 "fabd/ff/ff.tab.c"
        break;
      case 29: /* dependency */
/* Line 1393 of yacc.c  */
#line 104 "fabd/ff/ff.y"
...
/* Line 1570 of yacc.c  */
#line 42 "fabd/ff/ff.y"
{ memset(&yylloc, 0, sizeof(yylloc)); }
/* Line 1570 of yacc.c  */
#line 1618 "fabd/ff/ff.tab.c"
  yylsp[0] = yylloc;
  goto yysetstate;
