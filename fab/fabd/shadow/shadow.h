...
xapi shadow_module_init(struct module * restrict mod, struct graph_invalidation_context * restrict invalidation)
...
#if 0
/*
 * attach a node to the //module/import-scope directory
 *
 * mod          - module
 * ref          - node to attach
 ...
 */
xapi shadow_graft_import_scope(
    struct module * restrict mod
  , struct fsent * restrict ref
  , const char * restrict as
  , uint16_t asl
...
/*
 * attach a node to the //module/use-scope directory
 *
 * mod          - module
 * ref          - node to attach
 * as           - name to attach under
