...
API xapi rmdir_recursive(const char * const dirpath, int rmself)
{
  enter;
...
API xapi mkdirvpf(mode_t mode, const char * const restrict fmt, va_list va)
{
  enter;
