...
_E(7, CMDFAIL, "command failed to execute successfully") \
...
_E(16, FABPERMS, "fab executables must be owned by fabsys:fabsys and have ug+s permissions") \
_E(17, FABDLOCK, "fabd already running for this hash") \
_E(18, FABLOCK, "fab already running for this hash") \
