...
# define L_TIME					0x0000000000000040ULL
#if DEBUG || DEVEL
# define L_FFTOKEN 			0x0000000000000080ULL
...
#define L_BPEXEC				0x0000000000002000ULL
#define L_BPEVAL				0x0000000000004000ULL
#define L_BPDUMP				0x0000000000008000ULL
#define L_BPCMD					0x0000000000010000ULL
