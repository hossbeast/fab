...
# fab --bslic-fab -k install64.dist.debug.sh +n @install.dist.debug -K destdir -K incdir -K bindir -K mandir -K libdir -K dlibdir -K lwopdir -K fablwopdir -K fabtmpdir -K fabipcdir -K fabinvokedir
