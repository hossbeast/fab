...
#define L_IDEN					0x0000000000000008ULL | L_GREEN
#define L_ARGS 					0x0000000000000010ULL
#define L_PARAMS				0x0000000000000020ULL
#define L_FFTOKN 				0x0000000000000040ULL
#define L_FFSTAT 				0x0000000000000080ULL
...
#define L_DGHASH				0x0000000002000000ULL
#define L_DG 						0x0000000004000000ULL
