...
fml_1_0()
{
  ...
  exec 2>&100
	...
	gcc -m64 -Wall -Werror -D_GNU_SOURCE -fplan9-extensions -DXAPI_PROVIDE_BACKTRACE -I./common/unitstring -I./common/coll -I./common/wstdlib -I./common/parseint -I./common/memblk -I./common/logger -I./common/map -I./common/canon -I./common/yyutil -I./common/cksum -I./common/strutil -I./common/color -I./common/wstring -I./common -DBUILDSTAMP="`date`" -O0 -g -ggdb3 -DDEBUG -DXAPI_RUNTIME_CHECKS -DSANITY -I./libxapi -I./libxlinux -I./listwise/liblistwise -I./libpstring -c common/cksum/cksum.c -o common/cksum/cksum.debug.o
...
NAMES[2]='common/memblk/memblk.def.debug.o'
fml_1_2()
{
  exec 1>/dev/null
  exec 2>&102
...
NAMES[3]='common/memblk/memblk.def.debug.pic.o'
fml_1_3()
{
  exec 1>/dev/null
  exec 2>&103
...
NAMES[4]='common/parseint/parseint.debug.o'
fml_1_4()
{
  exec 1>/dev/null
  exec 2>&104
...
NAMES[5]='common/parseint/parseint.debug.pic.o'
fml_1_5()
{
  exec 1>/dev/null
  exec 2>&105
...
NAMES[6]='common/strutil/strutil.debug.o'
fml_1_6()
{
  exec 1>/dev/null
  exec 2>&106
...
NAMES[7]='common/strutil/strutil.debug.pic.o'
fml_1_7()
{
  exec 1>/dev/null
  exec 2>&107
...
NAMES[8]='common/unitstring/unitstring.debug.o'
fml_1_8()
{
  exec 1>/dev/null
  exec 2>&108
...
NAMES[9]='common/wstdlib/wstdlib.debug.o'
fml_1_9()
{
  exec 1>/dev/null
  exec 2>&109
...
NAMES[10]='common/wstdlib/wstdlib.debug.pic.o'
fml_1_10()
{
  exec 1>/dev/null
  exec 2>&110
...
NAMES[26]='common/canon/canon.debug.o'
fml_2_0()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[27]='common/canon/canon.debug.pic.o'
fml_2_1()
{
  exec 1>/dev/null
  exec 2>&101
...
NAMES[28]='common/coll/coll.debug.o'
fml_2_2()
{
  exec 1>/dev/null
  exec 2>&102
...
NAMES[29]='common/coll/coll.debug.pic.o'
fml_2_3()
{
  exec 1>/dev/null
  exec 2>&103
...
NAMES[30]='common/logger/logger.debug.o'
fml_2_4()
{
  exec 1>/dev/null
  exec 2>&104
...
NAMES[31]='common/map/map.debug.o'
fml_2_5()
{
  exec 1>/dev/null
  exec 2>&105
...
NAMES[32]='common/map/map.debug.pic.o'
fml_2_6()
{
  exec 1>/dev/null
  exec 2>&106
...
NAMES[33]='common/yyutil/yyutil.debug.o'
fml_2_7()
{
  exec 1>/dev/null
  exec 2>&107
...
NAMES[34]='common/yyutil/yyutil.debug.pic.o'
fml_2_8()
{
  exec 1>/dev/null
  exec 2>&108
...
NAMES[35]='fab/common/dirutil/dirutil.debug.o'
fml_2_9()
{
  exec 1>/dev/null
  exec 2>&109
...
NAMES[36]='fab/common/error/FAB.errtab.debug.o'
fml_2_10()
{
  exec 1>/dev/null
  exec 2>&110
...
NAMES[37]='fab/common/logs/logs.debug.o'
fml_2_11()
{
  exec 1>/dev/null
  exec 2>&111
...
NAMES[38]='fab/common/params/params.debug.o'
fml_2_12()
{
  exec 1>/dev/null
  exec 2>&112
...
NAMES[39]='fab/fabd/ff/ff.dsc.tab.debug.o'
fml_2_13()
{
  exec 1>/dev/null
  exec 2>&113
...
NAMES[40]='fab/fabd/ff/ff.list.tab.debug.o'
fml_2_14()
{
  exec 1>/dev/null
  exec 2>&114
...
NAMES[42]='fab/fabd/ff/ff.tab.debug.o'
fml_2_16()
{
  exec 1>/dev/null
  exec 2>&116
...
NAMES[44]='fab/fabd/ff/ff.var.tab.debug.o'
fml_2_18()
{
  exec 1>/dev/null
  exec 2>&118
...
NAMES[45]='fab/fabw/main.debug.o'
fml_2_19()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[74]='listwise/listwise/args/args.debug.o'
fml_2_48()
{
  exec 1>/dev/null
  exec 2>&110
...
NAMES[75]='listwise/listwise/error/LISTWISE.errtab.debug.o'
fml_2_49()
{
  exec 1>/dev/null
  exec 2>&111
...
NAMES[76]='listwise/listwise/logs/logs.debug.o'
fml_2_50()
{
  exec 1>/dev/null
  exec 2>&112
...
NAMES[77]='listwise/listwise/main.debug.o'
fml_2_51()
{
  exec 1>/dev/null
  exec 2>&113
...
NAMES[78]='common/memblk/memblk.debug.o'
fml_3_0()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[79]='common/memblk/memblk.debug.pic.o'
fml_3_1()
{
  exec 1>/dev/null
  exec 2>&101
...
NAMES[80]='fab/common/args/args.debug.o'
fml_3_2()
{
  exec 1>/dev/null
  exec 2>&102
...
NAMES[81]='fab/common/identity/identity.debug.o'
fml_3_3()
{
  exec 1>/dev/null
  exec 2>&103
...
NAMES[82]='fab/common/path/path.debug.o'
fml_3_4()
{
  exec 1>/dev/null
  exec 2>&104
...
NAMES[84]='fab/fabd/bp/bp.debug.o'
fml_3_6()
{
  exec 1>/dev/null
  exec 2>&106
...
NAMES[85]='fab/fabd/bs/bs.debug.o'
fml_3_7()
{
  exec 1>/dev/null
  exec 2>&107
...
NAMES[86]='fab/fabd/dep/dep.debug.o'
fml_3_8()
{
  exec 1>/dev/null
  exec 2>&108
...
NAMES[87]='fab/fabd/dsc/dsc.debug.o'
fml_3_9()
{
  exec 1>/dev/null
  exec 2>&109
...
NAMES[88]='fab/fabd/enclose/enclose.debug.o'
fml_3_10()
{
  exec 1>/dev/null
  exec 2>&110
...
NAMES[89]='fab/fabd/ff/ff.debug.o'
fml_3_11()
{
  exec 1>/dev/null
  exec 2>&111
...
NAMES[90]='fab/fabd/ff/ff.lex.debug.o'
fml_3_12()
{
  exec 1>/dev/null
  exec 2>&112
...
NAMES[91]='fab/fabd/ff/ff.states.debug.o'
fml_3_13()
{
  exec 1>/dev/null
  exec 2>&113
...
NAMES[92]='fab/fabd/ff/ff.tokens.debug.o'
fml_3_14()
{
  exec 1>/dev/null
  exec 2>&114
...
NAMES[93]='fab/fabd/ffn/ffn.debug.o'
fml_3_15()
{
  exec 1>/dev/null
  exec 2>&115
...
NAMES[94]='fab/fabd/ffproc/ffproc.debug.o'
fml_3_16()
{
  exec 1>/dev/null
  exec 2>&116
...
NAMES[95]='fab/fabd/fml/fml.debug.o'
fml_3_17()
{
  exec 1>/dev/null
  exec 2>&117
...
NAMES[96]='fab/fabd/gn/gn.debug.o'
fml_3_18()
{
  exec 1>/dev/null
  exec 2>&118
...
NAMES[97]='fab/fabd/gn/gnlw.debug.o'
fml_3_19()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[98]='fab/fabd/hashblock/hashblock.debug.o'
fml_3_20()
{
  exec 1>/dev/null
  exec 2>&101
...
NAMES[99]='fab/fabd/list/list.debug.o'
fml_3_21()
{
  exec 1>/dev/null
  exec 2>&102
...
NAMES[100]='fab/fabd/lwutil/lwutil.debug.o'
fml_3_22()
{
  exec 1>/dev/null
  exec 2>&103
...
NAMES[101]='fab/fabd/main.debug.o'
fml_3_23()
{
  exec 1>/dev/null
  exec 2>&104
...
NAMES[102]='fab/fabd/selector/selector.debug.o'
fml_3_24()
{
  exec 1>/dev/null
  exec 2>&105
...
NAMES[103]='fab/fabd/strstack/strstack.debug.o'
fml_3_25()
{
  exec 1>/dev/null
  exec 2>&106
...
NAMES[104]='fab/fabd/tmp/tmp.debug.o'
fml_3_26()
{
  exec 1>/dev/null
  exec 2>&107
...
NAMES[105]='fab/fabd/traverse/traverse.debug.o'
fml_3_27()
{
  exec 1>/dev/null
  exec 2>&108
...
NAMES[106]='fab/fabd/ts/ts.debug.o'
fml_3_28()
{
  exec 1>/dev/null
  exec 2>&109
...
NAMES[107]='fab/fabd/var/var.debug.o'
fml_3_29()
{
  exec 1>/dev/null
  exec 2>&110
...
NAMES[108]='libxapi/callstack/callstack.debug.pic.o'
fml_3_30()
{
  exec 1>/dev/null
  exec 2>&111
...
NAMES[109]='libxapi/error/SYS.errtab.debug.pic.o'
fml_3_31()
{
  exec 1>/dev/null
  exec 2>&112
...
NAMES[110]='libxapi/error/error.debug.pic.o'
fml_3_32()
{
  exec 1>/dev/null
  exec 2>&113
...
NAMES[112]='libxapi/frame/frame.debug.pic.o'
fml_3_34()
{
  exec 1>/dev/null
  exec 2>&115
...
NAMES[113]='libxapi/test.debug.pic.o'
fml_3_35()
{
  exec 1>/dev/null
  exec 2>&116
...
NAMES[114]='libxapi/trace/trace.debug.pic.o'
fml_3_36()
{
  exec 1>/dev/null
  exec 2>&117
...
NAMES[115]='listwise/liblistwise/describe/describe.debug.pic.o'
fml_3_37()
{
  exec 1>/dev/null
  exec 2>&118
...
NAMES[116]='listwise/liblistwise/error/PCRE.errtab.debug.pic.o'
fml_3_38()
{
  exec 1>/dev/null
  exec 2>&100
...
NAMES[117]='listwise/liblistwise/error/error.debug.pic.o'
fml_3_39()
{
  exec 1>/dev/null
  exec 2>&101
...
NAMES[118]='listwise/liblistwise/exec/exec.debug.pic.o'
fml_3_40()
{
  exec 1>/dev/null
  exec 2>&102
...
NAMES[120]='listwise/liblistwise/fs/fs.debug.pic.o'
fml_3_42()
{
  exec 1>/dev/null
  exec 2>&104
...
NAMES[121]='listwise/liblistwise/iterate/iterate.debug.pic.o'
fml_3_43()
{
  exec 1>/dev/null
  exec 2>&105
...
NAMES[122]='listwise/liblistwise/logging/logging.debug.pic.o'
fml_3_44()
{
  exec 1>/dev/null
  exec 2>&106
...
NAMES[123]='listwise/liblistwise/lstack/lstack.debug.pic.o'
fml_3_45()
{
  exec 1>/dev/null
  exec 2>&107
...
NAMES[124]='listwise/liblistwise/lwx/lwx.debug.pic.o'
fml_3_46()
{
  exec 1>/dev/null
  exec 2>&108
...
NAMES[125]='listwise/liblistwise/object/object.debug.pic.o'
fml_3_47()
{
  exec 1>/dev/null
  exec 2>&109
...
NAMES[128]='listwise/liblistwise/re/re.debug.pic.o'
fml_3_50()
{
  exec 1>/dev/null
  exec 2>&112
